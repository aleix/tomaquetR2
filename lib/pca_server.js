...
exports.listen = function(server) {
  ...
  io.sockets.on('connection', function (socket) {
    ...
    handleStartMotorRequest(socket);
   // cancelPinRequest(socket);
  });
};
...
function handleStartMotorRequest(socket) {
    socket.on('startMotor', function() {
...
function handleCancelPinRequest(soket){
	socket.on('cancelPin', function(pin){
